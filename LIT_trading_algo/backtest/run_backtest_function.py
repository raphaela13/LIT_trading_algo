from LIT_trading_algo.backtest.backtest_asia_range import *

import pandas as pd


def backtest (pair, start, end, rr, buffer, speed_factor):
    pd.set_option('display.max_columns', None)  # Show all columns
    initialize_mt()

    x = backtest_asia_range(pair, start, end, rr, buffer, speed_factor)
